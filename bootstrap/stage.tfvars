...
assume_role_arn = "arn:aws:iam::<STAGE_ACCOUNT_ID>:role/<BOOTSTRAP_ROLE_NAME>"

state_bucket_admin_principals = [
  "arn:aws:iam::<STAGE_ACCOUNT_ID>:role/<TF_STATE_ADMIN_ROLE_NAME>"
]

state_bucket_rw_principals = [
  "arn:aws:iam::<STAGE_ACCOUNT_ID>:role/<TF_STATE_RW_ROLE_NAME>"
]

kms_admin_principals = [
  "arn:aws:iam::<STAGE_ACCOUNT_ID>:role/<KMS_ADMIN_ROLE_NAME>"
]
